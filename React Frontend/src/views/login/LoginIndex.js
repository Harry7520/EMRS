...
import { checkNullOrBlank,checkPassword,validateIntegerOnly } from "../common/CommonValidation";
...
const LoginIndex = () => {
    ...
    const loginClick = async() => {
        ...
        }else if(!validateIntegerOnly(userCode)){
          err.push("Please fill code number!")
        }
