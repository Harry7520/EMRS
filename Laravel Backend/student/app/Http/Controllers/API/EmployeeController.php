...
class EmployeeController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        if($request->email != null) $query = $query->where('email',$request->email);
        if($request->japanese_skill != null) $query = $query->where('japanese_skill',$request->japanese_skill);
        if($request->english_skill != null) $query = $query->where('english_skill',$request->english_skill);
